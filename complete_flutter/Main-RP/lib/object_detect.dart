...
class object_detect extends StatefulWidget {
  object_detect() : super();

  final String title = "Flutter Save Image in Preferences";

  @override
  _object_detect createState() => _object_detect();
}

class _object_detect extends State<object_detect> {
  File? image;
  // Declare this variable
  String myText = "Initial Text";
  String obj_url =
      'https://storage.googleapis.com/mnrega-bucket/white.jpg-bafd6b40d90ee933.jpg';
  ...
  void UpdateObject(String url_object) {
    setState(() {
      obj_url = url_object;
    });
  }
  ...
  postRequest(String img_url) async {
    var url = 'https://darkturquoisestupendousmapping.syfnx800.repl.co/object';
    ...
    String url_object = jsonDecode(response.body)["img_link"];
    print("${url_object}");
    UpdateObject(url_object);

    // image = urlToFile(url_object) as File?;
